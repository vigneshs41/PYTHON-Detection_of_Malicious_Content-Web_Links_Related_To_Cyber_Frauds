...
score_mnb_count = mnb_tfidf.score(test_count_X, test_labels)
predictions_mnb_tfidf = mnb_tfidf.predict(test_count_X)
cmatrix_mnb_count = confusion_matrix(test_labels, predictions_mnb_tfidf)
creport_mnb_count = classification_report(test_labels, predictions_mnb_tfidf)
...
# retrieving the best model for prediction call
    load_model = pickle.load(open('/content/model.sav', 'rb'))
